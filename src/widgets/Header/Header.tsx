            ...
            >
              ...
              <label className={styles.investor_form_confirm}>
                ...
                <p>
                  ...
                  <a
                    href="#"
                    download="/src/assets/docs/Политика конфиденциальности.docx"
                  >
                  ...
                  <a
                    href="#"
                    download="/src/assets/docs/Пользовательское соглашение.docx"
                  >
              ...
              <label className={styles.investor_form_confirm}>
                <p>
                  ...
                  , за исключением связанных с рекламой условий, которые
                  действуют только при даче согласия на рекламу
                </p>
              </label>
            </form>
          </div>
